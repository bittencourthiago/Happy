...
export default function OrphanageDetails() {
    ...
    //Mesma coisa que uma view mas tem scroll 
    <ScrollView style={styles.container}>
        
        {/* Pagin enabled faz o scroll sempre passar a imagem completa, não a deixando pela metade */}
    ...
    <Text style={styles.description}>{orphanage.about}</Text>
        ...
        <View style={styles.mapContainer}>
          <MapView 
            ...
            //desabilitadas todas as ações do usuário
            zoomEnabled={false}
            pitchEnabled={false}
            scrollEnabled={false}
            rotateEnabled={false}
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>{orphanage.opening_hours}h</Text>
          </View>
